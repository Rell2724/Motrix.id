            ...
            <section class="frame-section">
                <div class="profile-parent">
                    ...
                    <div class="sidebar">
                        <div id="homebutton" class="home1">
                            <img class="home-2-icon" alt="" src="{{ asset('img/icons/home-2.png') }}" />
                ...
                <div class="frame-div">
                    ...
                    <div class="mask-group-parent">
                        <img class="mask-group-icon" alt="" src="{{ asset($movie->movie_banner) }}" />
                        <button class="rectangle-container">
                            <div class="frame-inner"></div>
                            <div href="{{ asset($movie->movie_trailer) }}" class="watch-the-trailer-wrapper">
                                <i class="watch-the-trailer">WATCH THE TRAILER</i>
                            </div>
                            <img class="play-button-1-icon" alt="" src="{{ asset('img/icons/play-button-1.png') }}" />
                        </button>
                    </div>
                    @endforeach
                    <div class="frame-parent1">
                        @foreach($top4movies as $topmovie)
                        <div class="movie-1-wrapper">
                            <div class="movie-1" id="MovieContainer">
                                <img class="rating-1-icon" alt="" src="{{ asset('img/icons/star.png') }}" />
                                <div class="rectangle-parent1">
                                    <img class="rectangle-icon" loading="lazy" alt="" src="{{ $topmovie->movie_poster }}" />
                                    <div class="frame-wrapper1">
                                        <div class="pasar-setan-horror-parent">
                                            <div class="pasar-setan-horror-container">
                                                <p class="pasar-setan">{{ $topmovie->movie_name }}</p>
                                                <p class="horror"><i>{{ $topmovie->genre }}</i></p>
                                            </div>
                    ...
                    <div class="frame-parent2">
                        <div id="show-more" class="show-more-wrapper">
